                ...
                <tr>
                   ...
                   <td>
                       @if($category->published)
                           <a href="{{route('categorys.pending',$category->id)}}" style="width: 80px" class="btn btn-success btn-sm" >Active</a>
                       @else
                           <a href="{{route('categorys.confirm',$category->id)}}" style="width: 80px"  class="btn btn-warning btn-sm">Pending</a>
