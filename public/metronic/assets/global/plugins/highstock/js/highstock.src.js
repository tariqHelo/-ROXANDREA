			...
			if (linkedParent) {
				...
				each(axis.series, function (series) {
					...
					if (!axis.single) {
						...
						// rooms for points with a pointRange, typically columns. When the pointPlacement option
						...
						// Determine the total padding needed to the length of the axis to make rooms for the
	...
	renderUnsquish: function () {
		...
		// Handle word-wrap or ellipsis on vertical axis
			...
			if (!textOverflowOption) {
				...
				// On vertical axis, only allow word wrap if there is rooms for more lines.
...
Chart.prototype = {
	...
	layOutTitles: function (redraw) {
		var titleOffset = 0,
			...
			requiresDirtyBox,
			renderer = this.renderer,
			autoWidth = this.spacingBox.width - 44; // 44 makes rooms for default context button
